...
var DYNAMIC_BASE = 5253840, DYNAMICTOP_PTR = 10928;
...
var wasmBinaryFile = 'compression.wasm';
if (window.WASM_URL) {
  wasmBinaryFile = window.WASM_URL + wasmBinaryFile;
} else if (!isDataURI(wasmBinaryFile)) {
...
Module['asm'] = function(global, env, providedBuffer) {
  ...
  env['table'] = wasmTable = new WebAssembly.Table({ 'initial': 28, 'maximum': 28, 'element': 'anyfunc' });
...
var _get_pointer = Module['_get_pointer'] = function() {
